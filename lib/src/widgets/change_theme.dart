...
class _ChangeThemeState extends State<ChangeTheme> {
  ...
  initState() {
    ...
    widgetName = widget.widgetName ??
        ThemeVendor.of(context).getWidgets().first.widgetName;
  }

  @override
  Widget build(BuildContext context) {
    return SimpleDialog(
      title: widget.widgetName == null
          ? DropdownButton(
              value: widgetName,
              items: ThemeVendor.of(context)
                  .getWidgets()
                  .map((widgetTheme) => DropdownMenuItem(
      ...
      children: ThemeVendor.of(context)
          ...
          .map((appTheme) => RadioListTile(
                ...
                groupValue: ThemeVendor.of(context)
                    .getThemeWidget(widgetName)
                    .themeName,
              ))
          .toList(),
    );
